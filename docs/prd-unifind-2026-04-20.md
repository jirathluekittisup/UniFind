...
> All technologies are from the 2190512 Application Development course curriculum.

| Layer | Technology | Course Week |
|---|---|---|
| Mobile Frontend | **React Native** (TypeScript) | Weeks 12–14 |
| Web Frontend | **HTML + CSS + JavaScript / TypeScript** | Weeks 10–11 |
| Backend API | **Flask** (Python) | Week 7 |
| Primary Database | **MySQL** | Weeks 5–6 |
| Real-time / Auth | **Firebase** (Auth + Firestore for notifications) | Week 6 |
| File Storage | **Firebase Storage** | Week 6 |
| Secondary Store | **MongoDB** (item photos metadata / unstructured data) | Week 4 |
| Auth Tokens | **JWT** (issued after login, sent with every API call) | Week 7 (Flask) |
| Containerization | **Docker** | Week 7 (extra) |
| Data Visualization | **Pandas + Plotly** (admin analytics dashboard) | Weeks 2–3 |
